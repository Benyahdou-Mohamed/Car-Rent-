...
export const SearchBar = () => {
    ...
    const [manufacturer,setManufacturer] : [string, React.Dispatch<React.SetStateAction<string>>] = useState('');;
    const [model,setModel] : [string, React.Dispatch<React.SetStateAction<string>>] = useState('');;
